  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .pz-smoke-a { width:55vw; height:55vw; left:-8%; top:-25%; background:radial-gradient(circle at 50% 50%, rgba(217,145,47,.82), rgba(217,145,47,0) 68%); animation:pzsA 8s ease-in-out infinite; }
        .pz-smoke-b { width:48vw; height:48vw; right:-6%; top:0%; background:radial-gradient(circle at 50% 50%, rgba(184,118,31,.78), rgba(184,118,31,0) 68%); animation:pzsB 11s ease-in-out infinite; }
        .pz-smoke-c { width:44vw; height:44vw; left:16%; bottom:-30%; background:radial-gradient(circle at 50% 50%, rgba(120,78,20,.5), rgba(120,78,20,0) 62%); animation:pzsC 13s ease-in-out infinite; }
        .pz-smoke-d { width:40vw; height:40vw; right:14%; bottom:-18%; background:radial-gradient(circle at 50% 50%, rgba(222,185,127,.95), rgba(222,185,127,0) 68%); animation:pzsD 9s ease-in-out infinite; }
