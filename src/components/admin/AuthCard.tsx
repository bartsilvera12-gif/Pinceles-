  ...
  return (
    ...
    >
      ...
      >
        ...
        <span aria-hidden style={{ display: "block", width: 30, height: 3, background: "#D9912F", margin: "22px 0 12px" }} />
        <h1 style={{ margin: 0, fontFamily: "var(--font-oswald), var(--font-sans)", textTransform: "uppercase", letterSpacing: ".01em", fontSize: 26, fontWeight: 700, color: "#050505" }}>{title}</h1>
